...
const Projects = ({ projects }) => {
  ...
  const nextSlide = () => {
    setCurrentIndex((prev) => (prev + 1 >= projectsData.length ? 0 : prev + 1));
  };
                      ...
                      <div className="project-image">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            fallback.textContent = project.title.substring(
                              0,
                              5,
                            );
                ...
                <div className="modal-image">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      fallback.textContent = selectedProject.title.substring(
                        0,
                        5,
                      );
                      e.target.parentElement.appendChild(fallback);
