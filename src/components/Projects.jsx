...
const Projects = ({ projects }) => {
  ...
  const defaultProjects = [
    { id: 1, title: "TRAVIA", subtitle: "Across the Galaxy", description: "Application de recherche d'itinéraires spatiaux inspirée de Star Wars. Utilisation de l'algorithme A* pour optimiser les trajets entre planètes.", image: "public/assets/projet1.jpeg", technologies: ["Java", "C", "PHP", "MySQL"], github: "https://github.com/KhephrenDjelidi", team: "Équipe de 3 - SAE BUT2", but: 2 },
    { id: 2, title: "WIKISPEED", subtitle: "Course contre la montre", description: "Jeu multijoueur où les joueurs doivent naviguer le plus rapidement possible entre des articles Wikipedia.", image: "public/assets/projet2.png", technologies: ["React", "Node.js", "MongoDB"], github: "https://github.com/KhephrenDjelidi", team: "Équipe de 4 - SAE BUT2", but: 2 },
    { id: 3, title: "BANKAI", subtitle: "Gestion bancaire", description: "Application de gestion de trésorerie pour entreprises avec génération de graphiques et export PDF.", image: "public/assets/projet3.png", technologies: ["PHP", "MySQL", "Scrum"], github: "https://github.com/KhephrenDjelidi", team: "Équipe de 5 - Méthode Agile", but: 2 },
    { id: 4, title: "HessNCF", subtitle: "Réservation de billets", description: "Système de réservation de billets de train avec recherche et gestion des voyages.", image: "public/assets/projet4.png", technologies: ["Node.js", "MongoDB", "HTML/CSS"], github: "https://github.com/KhephrenDjelidi", team: "Équipe de 5", but: 2 },
    { id: 5, title: "QIX", subtitle: "Jeu rétro revisité", description: "Recréation du célèbre jeu arcade QIX des années 80 en Python avec interface graphique.", image: "public/assets/projet5.png", technologies: ["Python", "Pygame"], github: "https://github.com/KhephrenDjelidi", team: "Binôme", but: 1 },
    { id: 6, title: "UNESCO Alger", subtitle: "Patrimoine culturel", description: "Application web en partenariat avec l'UNESCO pour mettre en valeur le patrimoine culturel d'Alger.", image: "public/assets/projet6.png", technologies: ["PHP", "MySQL", "HTML/CSS"], github: "https://github.com/KhephrenDjelidi", team: "Équipe de 6", but: 1 },
    { id: 7, title: "CoDec", subtitle: "Compresseur d'images", description: "Développement d'un compresseur d'images en C. Familiarisation avec la manipulation de fichiers binaires, les algorithmes de compression et la gestion de la mémoire en C.", image: "public/assets/projet7.png", technologies: ["C", "Binaire", "Algorithmes"], github: "https://github.com/KhephrenDjelidi", skills: ["C", "Binôme", "Binaire"], but: 3 },
    { id: 8, title: "Jenkins Project", subtitle: "Pipeline CI/CD", description: "Mise en place d'une pipeline CI/CD avec Jenkins. Configuration de Jenkins pour automatiser les tests, la construction et le déploiement d'une application web, permettant de comprendre l'intégration continue et le déploiement continu.", image: "public/assets/projet8.png", technologies: ["Jenkins", "Docker", "CI/CD"], github: "https://github.com/KhephrenDjelidi", skills: ["Jenkins", "Docker", "CI/CD"], but: 3 },
    { id: 9, title: "U-Activity", subtitle: "Gestion des activités universitaires", description: "Application web et mobile centralisée pour la gestion des activités universitaires. Intègre inscription, suivi, recherche avancée, messagerie interne et offre une expérience utilisateur optimisée pour étudiants et organisateurs.", image: "public/assets/projet9.png", technologies: ["React", "Node.js", "Android Studio", "Tailwind CSS"], github: "https://github.com/KhephrenDjelidi", skills: ["React", "Node.js", "Android Studio", "PHPMyAdmin", "Tailwind CSS"], but: 3 }
  ]
